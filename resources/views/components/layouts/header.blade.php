<header class="navbar">
      <div class="container navbar-content">
        ...
        <div class="navbar-auth">
          ...
          <a href="{{ route('car.watchlist') }}" class="btn btn-default">
            Mi Lista de Deseos
          </a>
          @endif
          @endauth
          ...
          <div class="navbar-menu" tabindex="-1">
            ...
            <ul class="submenu">
              ...
              <li>
                <a href="{{ route('car.index') }}">Mis Carros</a>
              </li>
              <li>
                <a href="{{ route('car.watchlist') }}">Mis Carros Favoritos</a>
              </li>
              @else
              <li>
                <a href="{{ route('verification.notice') }}">Verificar Correo</a>
              </li>
              @endif
              <li>
